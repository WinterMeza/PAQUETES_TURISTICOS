...
SELECT 
EXTRACT (YEAR FROM FECHA_PAGO) AS AñO,NOMBRE_A AS NOMBRE_AGENTE,TIPO_PT,CANTIDAD_PT FROM CONTRATACION
...
SELECT 
EXTRACT (YEAR FROM FECHA_PAGO) AS AñO ,TIPO_EMPRESA AS LUGAR,CANTIDAD_PT AS CANTIDAD FROM CONVENIOS
...
SELECT 
EXTRACT (YEAR FROM FECHA_PAGO ) AS AñO,NOMBRE_C,CANTIDAD_PT AS CANTIDAD_PAQUETES_COMPRADOS,TOTAL_PAGO 
...
TOTAL_VISITAS,BUENAS_VISITAS,MALAS_VISITAS FROM SASTIFACCION
